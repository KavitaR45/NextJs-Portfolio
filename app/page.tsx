    ...
    content: (
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Image src="/image/project/sync-3.png" height={635} width={1365} alt='sync-image'/>
          <Image src="/image/project/sync-4.png" height={635} width={1365} alt='sync-image'/>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Image src="/image/project/glastone-3.png" height={635} width={1365} alt='glastone-image'/>
        <Image src="/image/project/glastone-4.png" height={635} width={1365} alt='glastone-image'/>
      </div>
    </div>
    ),
  },
  {
    ...
    content: (
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Image src="/image/project/wvstor-3.png" height={635} width={1365} alt='wvstor-image'/>
        <Image src="/image/project/wvstor-4.png" height={635} width={1365} alt='wvstor-image'/>
      </div>
    </div>
    ),
  },
